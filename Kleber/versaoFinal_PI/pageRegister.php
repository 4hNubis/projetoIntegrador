...
<div class="container row">
        <div class="card-panel col s12 m8 l8 push-m2 push-l2">
            ...
            <div class="input-field col s12">
                <?php include 'ativaErro.php'; ?>
            </div>    
            <form action="ativaRegister.php" method="POST">
                <div class="col s12">
                ...
                <div class="col s12">
                    ...
                    <div class=" input-field col s12 l5 push-l1 ">
                        <input id="inpCPF" name="CPF" type="text" placeholder="xxx.xxx.xxx-xx" autocomplete="off" maxlength="14">
                ...
                <div class="col s12">
                    ...
                    <div class=" input-field col s12 l5 push-l1 ">
                        <input name="cep" id="cep" value="" onblur="pesquisacep(this.value);" type="text">
                ...
                <div class="col s12">
                    ...
                    <div class=" input-field col s12 l6  ">
                        <input name="dscComple" type="text">
